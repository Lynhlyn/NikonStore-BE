...
public class ImageUploadController {
  ...
  @Operation(
      ...
      description =
          "Tải lên một hoặc nhiều file hình ảnh vào thư mục được chỉ định. Hỗ trợ upload song song để tối ưu hiệu suất.")
  @ApiResponse(
      responseCode = "200",
  ...
  public ResponseEntity<?> uploadImages(
      ...
      @Parameter(
          ...
          String folder) {
    log.info("Received upload request for {} files to folder '{}'", files.size(), folder);
  ...
  @Operation(
      ...
      description =
          "Xóa một hoặc nhiều hình ảnh trên Cloudinary bằng URL. Hỗ trợ xóa song song để tối ưu hiệu suất.")
  @ApiResponse(
      responseCode = "200",
  ...
  public ResponseEntity<?> deleteImages(
    ...
    log.info("Received delete request for {} images", imageUrls.size());
  ...
  @Operation(
      ...
      description = "Xóa một hình ảnh trên Cloudinary bằng URL được truyền qua path parameter")
  @ApiResponse(
      responseCode = "200",
      description = "Xóa thành công",
      content =
  ...
  public ResponseEntity<?> deleteImage(
      @Parameter(
              ...
              required = true,
              example = "https://res.cloudinary.com/example/image/upload/v123/products/x.png")
          @PathVariable
          @NotBlank(message = "URL không được để trống")
          String imageUrl) {

    log.info("Received delete request for single image: {}", imageUrl);
