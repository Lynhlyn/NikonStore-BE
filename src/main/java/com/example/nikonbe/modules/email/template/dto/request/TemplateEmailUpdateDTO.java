...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Đối tượng yêu cầu cập nhật template email")
public class TemplateEmailUpdateDTO {
  ...
  @Schema(
      ...
      example = "Chào mừng bạn đến với hệ thống - Updated",
      required = true)
  ...
  @Schema(
      ...
      example = "<h1>Xin chào {{name}}</h1><p>Cảm ơn bạn đã đăng ký tài khoản thành công.</p>",
      required = true)
