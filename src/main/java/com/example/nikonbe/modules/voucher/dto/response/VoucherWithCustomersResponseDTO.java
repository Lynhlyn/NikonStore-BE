...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Thông tin phản hồi của voucher kèm danh sách khách hàng đã gán")
public class VoucherWithCustomersResponseDTO {
  ...
  @Schema(description = "Danh sách khách hàng đã được gán voucher")
  private List<CustomerResponseDTO> assignedCustomers;

  @Schema(description = "Tổng số khách hàng đã được gán voucher")
