...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Đối tượng yêu cầu cập nhật liên hệ")
public class ContactUpdateDTO {
  @NotBlank(message = "Tên liên hệ không được để trống")
  @Schema(description = "Tên liên hệ", example = "Nguyễn Văn B", required = true)
  private String name;
  ...
  @Schema(description = "Nội dung liên hệ", example = "Tôi muốn cập nhật...", required = true)
